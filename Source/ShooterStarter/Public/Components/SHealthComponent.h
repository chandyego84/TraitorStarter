...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_SixParams(FOnHealthChangedSignature, USHealthComponent*,
...
class SHOOTERSTARTER_API USHealthComponent : public UActorComponent
{
	GENERATED_BODY()
...
protected:
	...
	UFUNCTION() // being used with events
